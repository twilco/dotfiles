    ...
    if (clientDynamicRegisterSupport) {
        ...
        if (enableFormatter) {
            if (!formatterRegistration) {
                const documentSelector = [{ language: 'html' }, { language: 'handlebars' }]; // don't register razor, the formatter does more harm than good
...
connection.onCompletion((textDocumentPosition, token) => tslib_1.__awaiter(this, void 0, void 0, function* () {
...
connection.onDocumentRangeFormatting((formatParams, token) => tslib_1.__awaiter(this, void 0, void 0, function* () {
    return runner_1.runSafeAsync(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
